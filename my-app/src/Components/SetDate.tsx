...
function SetDate({ dateset, changeToday, day, onChange,onClickDay }: Dateprop) {
    ...
    return dateset == "today" ? (
        <div className="date">
            ...
            {day?.toString().slice(0,15)==dates.toString().slice(0,15)?<p>Today</p>:<p>{day?.toString().slice(3,10)}</p>}
        ...
        <div>
            ...
            {nodue && (
                <div className="calen">
                    ...
                    <SelectCalander day={day} onChange={onChange} onClickDay={onClickDay}/>
                </div>
            )}
        </div>
    );
